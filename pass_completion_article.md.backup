...
<p align="center">
  <img src="passing_location_heatmap.png" />
</p>
<div align="center">
<em>Heatmap of locations of all passes in the full dataset</em>
</div>
...
<p align="center">
  <img src="rolling_season_passes.png" />
</p>
<div align="center">
...
With this encoding in place, the split of the data is more clear: there's about 450,000 passes left, with about 395,000 a success, and about 55,000 incomplete passes overall. This represents a split of about 15% incomplete to 85% complete, which while not enormously problematic, needs consideration if only in the performance metrics selected to assess the model.
...
<p align="center">
  <img src="cumulative_season_events.png" />
</p>
<div align="center">
